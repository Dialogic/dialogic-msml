...
//
///////////////////////////////////////////////////////////////////////////////
// File Name: CMsmlDialogVoiceMailRecord.cpp
//
// Description: CMsmlDialogVoiceMailRecord class implementation
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Function: CMsmlDialogVoiceMailRecord::CMsmlDialogVoiceMailRecord(const std::string &a_connectionId, const std::string &a_mailbox)
//
...
//
///////////////////////////////////////////////////////////////////////////////
CMsmlDialogVoiceMailRecord::CMsmlDialogVoiceMailRecord( 
...
<msml version=\"1.1\" id=\"conn:" + a_connectionId + "\">\r\n\
   <dialogstart target=\"conn:" + a_connectionId + "\" type=\"application/moml+xml\">\r\n\
      <group topology=\"parallel\">\r\n\
        <record dest=\"" + l_mediaPath + "/Mailbox_" + a_mailbox + ".wav\" format=\"audio/wav;codec=mulaw\" \r\n\
            audiosamplerate=\"8\" audiosamplesize=\"8\" beep=\"true\">\r\n\
            <recordexit>\r\n\
