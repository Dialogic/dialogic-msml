...
//
///////////////////////////////////////////////////////////////////////////////
// File Name: CMsmlDialogVoiceMailPlay.cpp
//
// Description: CMsmlDialogVoiceMailPlay class implementation
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Function: CMsmlDialogVoiceMailPlay::CMsmlDialogVoiceMailPlay(const std::string &a_connectionId, const std::string &a_mailbox)
//
...
//
///////////////////////////////////////////////////////////////////////////////
CMsmlDialogVoiceMailPlay::CMsmlDialogVoiceMailPlay( 
...
<msml version=\"1.1\" id=\"conn:" + a_connectionId + "\">\r\n\
   <dialogstart target=\"conn:" + a_connectionId + "\" type=\"application/moml+xml\">\r\n\
      <group topology=\"parallel\">\r\n\
         <play>\r\n\
            <audio uri=\"" + l_mediaPath + "/Mailbox_" + a_mailbox + ".wav\" format=\"audio/wav\"/>\r\n\
            <playexit>\r\n\
