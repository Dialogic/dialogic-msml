...
//
///////////////////////////////////////////////////////////////////////////////
// File Name: CMsmlDialogVideoMailRecordStart.cpp
//
// Description: CMsmlDialogVideoMailRecordStart class implementation
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Function: CMsmlDialogVideoMailRecordStart::CMsmlDialogVideoMailRecordStart(const std::string &a_connectionId, const std::string &a_mailbox)
//
...
//
///////////////////////////////////////////////////////////////////////////////
CMsmlDialogVideoMailRecordStart::CMsmlDialogVideoMailRecordStart( 
...
<msml version=\"1.1\" id=\"conn:" + a_connectionId + "\">\r\n\
   <dialogstart target=\"conn:" + a_connectionId + "\" type=\"application/moml+xml\">\r\n\
      <group topology=\"parallel\">\r\n\
         <play>\r\n\
            <media> \r\n\
               <audio uri=\"" + l_mediaPath + "/VMailRecord.pcm\" \r\n\
                  format=\"aaudio/proprietary;codecs=linear\" audiosamplerate=\"8\" audiosamplesize=\"16\"/> \r\n\
               <video uri=\"" + l_mediaPath + "/VMailRecord.vid\" format=\"video/proprietary;codecs=h263\"/> \r\n\
            </media> \r\n\
            <playexit>\r\n\
